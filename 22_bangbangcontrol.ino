...
// Servo adjustment
#define _DUTY_MAX 2208  // Servo angle: D degree
#define _DUTY_NEU 1458  // Servo angle: 0 degree
#define _DUTY_MIN 722   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 133 // Replace with |D - E| degree
#define _SERVO_SPEED 300 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE 380
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 1179 + -6.72*a_value + 0.0136*a_value*a_value + -9.4E-06*a_value*a_value*a_value;
}
